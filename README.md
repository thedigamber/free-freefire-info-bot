# Free FreeFire Info Bot — Premium Rebrand
...
---
**Rebranded by:** Digamber Fuckner

**Theme:** Aesthetic Navy + Cyan

### What's changed
- Updated embed responses to a premium Navy + Cyan theme.
- All credits changed to Digamber Fuckner.

### Developer notes
Keep same runtime and dependencies as before. See `app.py` and `cogs/infoCommands.py` for embed templates.
  ```ini
  TOKEN=your_bot_token
  PORT = port where the bot will turn
  ```
